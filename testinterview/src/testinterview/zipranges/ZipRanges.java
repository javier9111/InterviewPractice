...
//		[94133,94133] [94200,94299] [94226,94399]
		...
		collectionOfRanges.add(new ZipCodeRange(94200,94299));
		
		collectionOfRanges.add(new ZipCodeRange(94226,94399));
	...
	{	
		...
		for ( ZipCodeRange zipRange : collectionOfRanges)
		{
			 ...
			 * I have added a +1 for the scenario that the next zip range has the lower bound as the number that follows the upper bound of the previous zip range
			 * Example [94100,94133] , [94134,94200] == [94100,94200]
			 */
